...
export const taApp = {
  ...
  sidebarLabels: {
    ...
    'Target interview questions': 'இலக்கு நேர்காணல் கேள்விகள்',
    'Top 10 micro frontend questions': 'முக்கிய 10 micro frontend கேள்விகள்',
    Testing: 'சோதனை',
    Observability: 'கண்காணிப்புத் திறன்',
    'Frontend production diagnostics':
      'Frontend production சிக்கல் பகுப்பாய்வு',
    ...
    'React Hooks': 'React Hooks பாடங்கள்',
    'Rules of Hooks': 'Hooks விதிகள்',
    'React 18 Changes': 'React 18 மாற்றங்கள்',
    'React 18 Overview': 'React 18 சுருக்கம்',
    'Automatic Batching': 'தானியங்கி Batching',
    'React 19 Changes': 'React 19 மாற்றங்கள்',
    'React 19 Overview': 'React 19 சுருக்கம்',
    'State management': 'State நிர்வாகம்',
    'Slice + reducers': 'Slice மற்றும் reducers',
    'Store example': 'Store எடுத்துக்காட்டு',
    'React Performance': 'React செயல்திறன்',
    'Why and how to test': 'ஏன், எவ்வாறு சோதிப்பது?',
    'Render profiling demo': 'Render profiling விளக்கம்',
    'SSR rendering': 'SSR rendering பாடம்',
    'CSR rendering': 'CSR rendering பாடம்',
    'Java for the Impatient': 'Core Java கற்றல் புத்தகம்',
    'Book overview': 'புத்தகச் சுருக்கம்',
    'Chapter 1': 'அத்தியாயம் 1',
    'Chapter 2': 'அத்தியாயம் 2',
    'Next.js Fundamentals': 'Next.js அடிப்படைகள்',
    'Intro to Next.js': 'Next.js அறிமுகம்',
    'Server and Client Components': 'Server மற்றும் Client Components',
    'Caching and revalidation': 'Caching மற்றும் மறுசரிபார்ப்பு',
    'Production Next.js': 'Production Next.js',
    'Middleware and proxy': 'Middleware மற்றும் proxy',
    'Layouts and route groups': 'Layouts மற்றும் route groups',
    'SEO and metadata': 'SEO மற்றும் metadata',
    'Deployment and monitoring': 'Deployment மற்றும் கண்காணிப்பு',
