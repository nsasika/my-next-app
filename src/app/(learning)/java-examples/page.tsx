...
const chapters = [
  ...
  {
    body: 'Functional decomposition, classes, object construction, records, static members, and packages.',
...
export default function JavaExamplesPage() {
  return (
    <>
      <PageHeader
        description="Book notes are split by chapter so each section can grow independently as you continue studying."
        eyebrow="Java track"
